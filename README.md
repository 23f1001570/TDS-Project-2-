...
└── GOOGLE_FORM_GUIDE.md    # Form submission instructions
```
...
- **GOOGLE_FORM_GUIDE.md**: Instructions for Google Form submission
- **Code comments**: Inline documentation in all modules

## 🎓 Google Form Submission

Before submitting the Google Form, ensure:
1. ✅ Server runs without errors
2. ✅ Test endpoint passes all tests
3. ✅ API endpoint is publicly accessible (or using ngrok)
4. ✅ GitHub repo is public with MIT LICENSE
5. ✅ Prompts are ≤100 characters

See `GOOGLE_FORM_GUIDE.md` for detailed instructions.
...
This is a student project for TDS. Feel free to fork and modify for your own submission.

## ⚠️ Important Notes

- Quiz evaluation: **Sat 29 Nov 2025, 3:00-4:00 pm IST**
- Time limit per quiz chain: **3 minutes**
- Maximum payload size: **1MB**
- Make GitHub repo public before evaluation
- Keep server running during evaluation period

## 📞 Support

For questions about the project requirements, refer to the original project brief.
